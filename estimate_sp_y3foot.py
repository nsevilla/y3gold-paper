...
def plot_sp_info(datadir,maptype,xlabel,threshold,generate_maps,histmin,histmax):
...
def main():
    ...
    parser.add_option("-d","--datadir",type="string",dest="datadir",help="Directory containing SP data",default="/Users/nsevilla/des/")
    parser.add_option("-m","--maptype",type="string",dest="maptype",help="Type of SP maps",default="skybrite")
    parser.add_option("-x","--xlabel",type="string",dest="xlabel",help="Label for histograms",default="")
    parser.add_option("-t","--threshold",type="int",dest="threshold",help="Threshold",default=12000)
    parser.add_option("--histmin",type="float",dest="histmin",default=0)
    parser.add_option("--histmax",type="float",dest="histmax",default=1)
    ...
    plot_sp_info(options.datadir,options.maptype,options.xlabel,options.threshold,options.generate_maps,options.histmin,options.histmax)
